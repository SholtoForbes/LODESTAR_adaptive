function [Isp,wf,eq,q1,w,T1,P1,M1] = RESTint(M, Alpha, auxdata,T0,P0)
...
% Isp = rbfinterp([M1';T1'],auxdata.interp.Isprbf)';

% Isp = auxdata.interp.Isp_interpolator(M1,T1);

% Isp = polyvaln(auxdata.interp.Isppoly,[M1,T1]);
